...
<html>
<head>
<title>SSP | Tours and Travels</title>
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="font-size: 3.7em;visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">ENQUIRY FORM</h3>
...
<b>Email</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Valid Email id" required="">
	...
	<p style="width: 350px;">
<b>Mobile No</b>  <input type="text" name="mobileno" class="form-control" id="mobileno" maxlength="10" placeholder="10 Digit mobile No" required pattern="[0-9]{10}">
	</p> 
